...
<div className="dropdown nav-item bg-dark-custom" id="dropdown">
  ...
  <ul className="dropdown-menu"  style={{backgroundColor: "#212529"}} aria-labelledby="dropdownMenuButton">
    <li><Link href="/admin/admin" className="dropdown-item" style={{color: "white", backgroundColor: "#212529"}}>Panel Admina</Link></li>
    <li><Link href="/admin/editor" className="dropdown-item" style={{color: "white", backgroundColor: "#212529"}}>Dodaj artykuł</Link></li>
  </ul>
